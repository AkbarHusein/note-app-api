...
CREATE TABLE `Note` (
    ...
    `categories_name` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `Note` ADD CONSTRAINT `Note_categories_name_fkey` FOREIGN KEY (`categories_name`) REFERENCES `Categoriess`(`name`) ON DELETE SET NULL ON UPDATE CASCADE;
